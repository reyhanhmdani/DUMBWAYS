...
export default function HomeScreen() {
  ...
  const renderProduct = ({ item }: { item: (typeof DUMMY_POST)[0] }) => (
    <View style={styles.card}>
      ...
      <TouchableOpacity style={styles.buyButton} activeOpacity={0.7} onPress={() => navigation.navigate("Detail", { product: item })}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.avatarButton} onPress={() => navigation.navigate("Profile", { id: 1, name: "Raihan Hamdani" })}>
